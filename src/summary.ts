        ...
        try {
            ...
            const messages = [
                vscode.LanguageModelChatMessage.User(
                    `You are a technical writer helping a developer summarize their daily work for a stand-up meeting or agile board update.
...
Write a clear, professional summary suitable for a daily stand-up or agile board update. Be specific about what was accomplished based on the actual code changes.`
    ...
    private async extractAITasks(gitData: GitData): Promise<string[]> {
        try {
            ...
            const messages = [
                vscode.LanguageModelChatMessage.User(
                    `Based on the following code changes from today's work, identify future tasks or work items that should be created.
