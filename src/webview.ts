...
export class DailySummaryProvider implements vscode.WebviewViewProvider {
    public static readonly viewType = 'dailySummaryView';
    ...
    private async _getAvailableModels() {
        try {
            ...
            const selectedModel = vscode.workspace.getConfiguration('dailyCodeSummary').get<string>('aiModel', 'auto');
